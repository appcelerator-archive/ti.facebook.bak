...
- (void)viewDidLoad {
    ...
    UIImageView *logo = [[[UIImageView alloc] 
                         initWithImage:[UIImage imageNamed:@"modules/facebook/FBUserSettingsViewResources.bundle/images/facebook-logo.png"]] autorelease];
    ...
    UIImage *image = [UIImage imageNamed:@"modules/facebook/FBUserSettingsViewResources.bundle/images/silver-button-normal.png"];
    [self.loginLogoutButton setBackgroundImage:image forState:UIControlStateNormal];
    image = [UIImage imageNamed:@"modules/facebook/FBUserSettingsViewResources.bundle/images/silver-button-pressed.png"];
...
- (void)updateBackgroundImage {
    ...
    NSString *imagePath = [NSString stringWithFormat:@"modules/facebook/FBUserSettingsViewResources.bundle/images/loginBackground%@%@.jpg", idiom, orientation];
