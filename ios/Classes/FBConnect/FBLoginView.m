...
- (void)initialize {
    ...
    UIImage *image = [[UIImage imageNamed:@"modules/facebook/FacebookSDKResources.bundle/FBLoginView/images/login-button-small.png"] 
                      stretchableImageWithLeftCapWidth:kButtonLabelX topCapHeight:0];
    g_imageSize = image.size;
    [self.button setBackgroundImage:image forState:UIControlStateNormal];
    
    image = [[UIImage imageNamed:@"modules/facebook/FacebookSDKResources.bundle/FBLoginView/images/login-button-small-pressed.png"]
             stretchableImageWithLeftCapWidth:kButtonLabelX topCapHeight:0];
